...
class SysTrayIcon(object):
    ...
    def update_menus(self, menu_options):
        menu_options = menu_options + (('Quit', 'icon/quit.ico', self.QUIT),)
...
if __name__ == '__main__':
    ...
    menu_options = (('Say Hello', 'icon/recaptcha.ico', hello),
    ...
    SysTrayIcon(next(icons), hover_text, menu_options, on_quit=bye, default_menu_index=1).start()